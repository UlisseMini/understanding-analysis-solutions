...
\begin{solution}
  ...
  \item First let $x \in g^{-1}(A \cap B)$ meaning $g(x) \in A \cap B$ implying $g(x) \in A$ and $g(x) \in B$ which is the same as $x \in g^{-1}(A)$ and $x \in g^{-1}(B)$ meaning $x \in g^{-1}(A) \cap g^{-1}(B)$. \par
    Second let $x \in g^{-1}(A) \cap g^{-1}(B)$, this is the same as $x \in g^{-1}(A)$ and $x \in g^{-1}(B)$ which is the same as $g(x) \in A$ and $g(x) \in B$ implying $g(x) \in A \cap B$ and thus $x \in g^{-1}(A \cap B)$.
  }
\end{solution}
...
\begin{solution}
  \enum{
  \item Suppose $y_n > -6$, then $y_{n+1} = (2y_n - 6)/3$ implying $y_n = (3y_{n+1} + 6)/2 > -6$ implying $y_{n+1} > -6$ by basic algebra.
  \item Suppose $y_{n+1} < y_{n}$ this implies $2y_{n+1} < 2y_n$ implying $2y_{n+1} - 6 < 2y_n - 6$ and finally $(2y_{n+1} - 6)/3 < (2y_n - 6)/3$ which shows $y_{n+2} < y_{n+1}$.
  }
\end{solution}
