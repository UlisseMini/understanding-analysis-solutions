...
\begin{solution}
  ...
  \item
    ...
    \item If $E^\circ = E$ then every $x \in E$ has $V_\epsilon(x) \subseteq E$ therefor $E$ is open. If $E$ is open then every $x \in E$ has $V_\epsilon(x) \subseteq E$ therefor $E = E^\circ$.
    }
  \item $x \in \closure{E}^c$ iff $x \notin E$ and $x$ is not a limit point of $E$, $x \in (E^c)^\circ$ iff $x \notin E$ and there exists $V_\epsilon(x) \subseteq E^c$. Notice ``x is not a limit point of $E$'' is equivilant to ``there exists $V_\epsilon(x) \subseteq E^c$'' therefor the sets are the same.
