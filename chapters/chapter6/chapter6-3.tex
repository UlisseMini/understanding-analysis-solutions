...
\enum{
    ...
    \[\lim_{n \to \infty} f'_n(x) = \frac{1 - nx^2}{1 + 2nx^2 + n^2 x^4} = \frac{\frac{1}{n} - x^2}{\frac{1}{n} + 2x^2 + nx^4}\]
    For \(x = 0\) this is 1; everywhere else this is 0. Therefore \(f'(x) = \lim f'_n(x)\) on \(\mathbb{R} \backslash \{0\}\).
}
\end{solution}
\begin{exercise}
  Let
