...
\begin{solution}
  ...
  \item By EVT $g$ obtains a minimum value over $[a,b]$. We just showed $a$ and $b$ are not minima, therefor the minimum point $c$ must be in the interior $(a,b)$ which has $g'(c) = 0$ by Theorem 5.2.6.
  }
\end{solution}
