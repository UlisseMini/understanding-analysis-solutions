...
\begin{solution}
  ...
  \item Let $a_{mn} = 1 / \min\{m,n\}$. both iterated limits are infinity since
    $$\lim_{n \to \infty}\left(\lim_{m \to \infty} a_{mn}\right) = \lim_{n \to \infty}\left(n\right) = \infty$$
    But increasing both at the same time gives zero
